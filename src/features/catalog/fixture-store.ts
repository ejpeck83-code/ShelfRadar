...
const fixtureProducts: ProductView[] = [
  {
    ...
    listings: [
      { id: "target:91234567", retailerKey: "target", retailer: "Target", url: "https://www.target.com/p/-/A-91234567", priceMinor: 3499, status: "ACTIVE", availability: [
      ...
      { id: "walmart:147258369", retailerKey: "walmart", retailer: "Walmart", url: "https://www.walmart.com/ip/147258369", priceMinor: 3499, status: "ACTIVE", availability: [
        { status: "IN_STOCK", observedAt: "2026-07-18T16:05:00.000Z", storeName: "Walmart Indianapolis area", sourceAvailable: true }
      ] },
      { id: "neca:NECA-54133", retailerKey: "neca", retailer: "NECA Store", url: "https://store.necaonline.com/products/tmnt-last-ronin-leonardo-sanitized", priceMinor: 3499, status: "ACTIVE", availability: [
  ...
  },
  {
    ...
    listings: [
      { id: "target:92345678", retailerKey: "target", retailer: "Target", url: "https://www.target.com/p/-/A-92345678", priceMinor: 5999, status: "ACTIVE", availability: [{ status: "ONLINE_ONLY", observedAt: "2026-07-18T16:00:00.000Z", storeName: "Target online", sourceAvailable: true }] },
      { id: "walmart:258369147", retailerKey: "walmart", retailer: "Walmart", url: "https://www.walmart.com/ip/258369147", priceMinor: 5999, status: "ACTIVE", availability: [{ status: "ONLINE_ONLY", observedAt: "2026-07-18T16:05:00.000Z", storeName: "Walmart online", sourceAvailable: true }] }
    ],
  ...
  },
  {
    ...
    listings: [{ id: "target:93456789", retailerKey: "target", retailer: "Target", url: "https://www.target.com/p/-/A-93456789", priceMinor: 5499, status: "OUT_OF_STOCK", availability: [{ status: "OUT_OF_STOCK", observedAt: "2026-07-18T16:00:00.000Z", storeName: "Target Westfield", sourceAvailable: true }] }],
  ...
  },
  {
    ...
    listings: [{ id: "meijer:MEI-901245", retailerKey: "meijer", retailer: "Meijer", url: "https://www.meijer.com/shopping/product/MEI-901245.html", priceMinor: 999, status: "ACTIVE", availability: [{ status: "UNKNOWN", observedAt: "2026-07-10T13:10:00.000Z", storeName: "Meijer Indianapolis area", sourceAvailable: true }] }],
